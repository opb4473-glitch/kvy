...
export default function PageNavigation({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-background via-background/80 to-transparent pt-10 pb-6 px-4">
      <div className="max-w-2xl mx-auto flex items-center justify-between gap-3">
          ...
          {Array.from({ length: totalPages }, (_, i) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-center rounded-full transition-all duration-500 w-fit h-fit p-2 ${i === currentPage
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-full font-semibold text-base transition-all duration-300 disabled:opacity-25 disabled:cursor-not-allowed disabled:hover:scale-100 bg-gradient-to-r from-rose-400 to-amber-400 text-white shadow-md hover:shadow-xl hover:scale-105 active:scale-95"
        >
